...
long long CThread::
GetCPUTime(const LARGE_INTEGER &frequency) const
{
    ...
    if (m_LastCpu > 0)
    {
        cpu = (total - m_LastCpu) * 10000 / ((counter.QuadPart - m_LastCounter.QuadPart) *
