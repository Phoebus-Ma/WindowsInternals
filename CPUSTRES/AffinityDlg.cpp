...
CAffinityDlg::
CAffinityDlg(bool affinity, CThread *pThread, const CString &title, CWnd *pParent)
    : CDialogEx(IDD_AFFINITY, pParent), m_Affinity(affinity), m_Title(title), m_pThread(pThread)
{
}

CAffinityDlg::
CAffinityDlg(const CString &title, CWnd *pParent) : CDialogEx(IDD_AFFINITY, pParent), m_Title(title), m_Process(true), m_Affinity(true)
{
}
