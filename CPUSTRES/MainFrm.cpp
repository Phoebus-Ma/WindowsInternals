...
void CMainFrame::
OnUpdateOptionsAlwaysontop(CCmdUI *pCmdUI)
{
...
SetProcessPriorityClassText()
{
    ...
    m_wndDlgBar.GetDlgItem(IDC_PRIORITYCLASS)->SetWindowText(CString(L"Process Priority Class: ") +
                PriorityClassToString(priority));
}

PCWSTR CMainFrame::
PriorityClassToString(int priority)
{
    switch (priority)
    {
