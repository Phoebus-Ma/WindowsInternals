...
CThreadsListCtrl::
CThreadsListCtrl(const std::vector<std::unique_ptr<CThread>> &threads) : m_Threads(threads)
{
}
...
COLORREF CThreadsListCtrl::
OnGetCellBkColor(int nRow, int nColumn)
{
...
COLORREF CThreadsListCtrl::
OnGetCellTextColor(int nRow, int nColumn)
{
    auto thread = GetThread(nRow);
...
CThread *CThreadsListCtrl::
GetThread(int row) const
{
